...
BLACK_PANTHER_TIPS = (
    ...
    "4) Combos & Variations. Since dashing a vibranium marked target resets your dash, the main combos involve using spear toss to mark targets, then dashing through them, then spear toss again, another dash, and finishing with spinning kick, dashing again once spinning kick marks the target and using the final dash to escape. Placing spinning kick in the middle of the combo can be useful in certain situations.\n\n"
